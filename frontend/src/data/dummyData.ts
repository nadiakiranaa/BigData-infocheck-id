...
export const feedItems: FeedItem[] = [
  ...
  },
  {
    ...
    snippet: 'Pesan investasi cepat untung membawa nama lembaga negara dan dompet digital...',
    status: 'Review',
    confidence: 68,
  },
  {
    ...
    snippet: 'Promosi token kripto palsu mengatasnamakan bursa resmi nasional...',
    status: 'Scam',
    confidence: 96,
  },
];
